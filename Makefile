...
# 源文件（带路径）
SRCS = src/main.c src/gpio.c src/usart.c src/power.c com/kfifo.c com/universal.c src/llcc68.c app/thread_summary.c src/eg800k.c src/watch_dog.c src/bluetooth.c src/bd3.c
